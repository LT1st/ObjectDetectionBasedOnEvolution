...
if __name__ == '__main__':
    ...
    ev = Evolve_CNN(m_prob=0.2, m_eta=0.05, x_prob=0.9, x_eta=0.05, population_size=10, train_data=None,
                    train_label=None, validate_data=None,validate_label=None, number_of_channel=1,batch_size=100,
                    epochs=1,train_data_length=100,validate_data_length=100, eta=1)
