...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op6 = DenseNetUnit(k=20, amount=9, in_channel=244, out_channel=244, max_input_channel=64)
        self.op7 = DenseNetUnit(k=12, amount=6, in_channel=244, out_channel=200, max_input_channel=128)
