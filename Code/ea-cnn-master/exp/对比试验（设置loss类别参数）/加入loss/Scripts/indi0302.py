...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=8, in_channel=183, out_channel=256)
        self.op4 = DenseNetUnit(k=12, amount=5, in_channel=256, out_channel=188, max_input_channel=128)
        self.op5 = ResNetUnit(amount=8, in_channel=188, out_channel=256)
        self.op6 = DenseNetUnit(k=12, amount=5, in_channel=256, out_channel=188, max_input_channel=128)
        self.op7 = ResNetUnit(amount=11, in_channel=188, out_channel=128)
        self.op8 = ResNetUnit(amount=3, in_channel=128, out_channel=128)
        self.op11 = ResNetUnit(amount=3, in_channel=128, out_channel=128)
