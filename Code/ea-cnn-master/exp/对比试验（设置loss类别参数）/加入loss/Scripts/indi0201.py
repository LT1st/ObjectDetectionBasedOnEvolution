...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = ResNetUnit(amount=10, in_channel=128, out_channel=128)
        self.op3 = DenseNetUnit(k=40, amount=5, in_channel=128, out_channel=232, max_input_channel=32)
        self.op5 = ResNetUnit(amount=4, in_channel=232, out_channel=256)
        self.op6 = ResNetUnit(amount=11, in_channel=256, out_channel=128)
        self.op7 = ResNetUnit(amount=3, in_channel=128, out_channel=128)
        self.op8 = ResNetUnit(amount=8, in_channel=128, out_channel=256)
        self.op9 = DenseNetUnit(k=12, amount=5, in_channel=256, out_channel=188, max_input_channel=128)
        self.op10 = DenseNetUnit(k=20, amount=9, in_channel=188, out_channel=244, max_input_channel=64)
