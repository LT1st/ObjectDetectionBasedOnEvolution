...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=3, in_channel=3, out_channel=128)
        self.op1 = ResNetUnit(amount=8, in_channel=128, out_channel=64)
        self.op3 = ResNetUnit(amount=10, in_channel=64, out_channel=128)
        self.op4 = DenseNetUnit(k=40, amount=5, in_channel=128, out_channel=232, max_input_channel=32)
        self.op5 = DenseNetUnit(k=40, amount=5, in_channel=232, out_channel=232, max_input_channel=32)
        self.op7 = ResNetUnit(amount=8, in_channel=232, out_channel=256)
        self.op8 = DenseNetUnit(k=12, amount=5, in_channel=256, out_channel=188, max_input_channel=128)
        self.op9 = ResNetUnit(amount=11, in_channel=188, out_channel=128)
        self.op10 = ResNetUnit(amount=3, in_channel=128, out_channel=128)
        self.op13 = ResNetUnit(amount=3, in_channel=128, out_channel=128)
