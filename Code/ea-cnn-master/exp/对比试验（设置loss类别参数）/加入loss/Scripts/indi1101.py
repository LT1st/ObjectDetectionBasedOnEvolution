...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = DenseNetUnit(k=12, amount=5, in_channel=183, out_channel=188, max_input_channel=128)
        self.op4 = DenseNetUnit(k=20, amount=9, in_channel=188, out_channel=244, max_input_channel=64)
