...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op5 = DenseNetUnit(k=20, amount=9, in_channel=188, out_channel=244, max_input_channel=64)
        self.op8 = DenseNetUnit(k=20, amount=4, in_channel=244, out_channel=144, max_input_channel=64)
        self.op9 = DenseNetUnit(k=40, amount=5, in_channel=144, out_channel=232, max_input_channel=32)
        self.op10 = ResNetUnit(amount=12, in_channel=232, out_channel=64)
