...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op5 = DenseNetUnit(k=12, amount=5, in_channel=188, out_channel=188, max_input_channel=128)
        self.op6 = DenseNetUnit(k=20, amount=9, in_channel=188, out_channel=244, max_input_channel=64)
