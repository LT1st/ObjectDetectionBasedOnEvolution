...
class Individual(object):
    ...
    def initialize(self):
        ...
        num_resnet = np.random.randint(self.min_resnet , self.max_resnet+1)  #(1,5)
        num_pool = np.random.randint(self.min_pool , self.max_pool+1)  #(4,5)
        num_densenet = np.random.randint(self.min_densenet, self.max_densenet+1)  #(1,5)
