...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=40, amount=5, in_channel=203, out_channel=232, max_input_channel=32)
        self.op3 = DenseNetUnit(k=12, amount=3, in_channel=232, out_channel=164, max_input_channel=128)
        self.op5 = DenseNetUnit(k=20, amount=3, in_channel=164, out_channel=124, max_input_channel=64)
        self.op7 = DenseNetUnit(k=20, amount=6, in_channel=124, out_channel=184, max_input_channel=64)
