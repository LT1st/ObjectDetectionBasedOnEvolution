...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=40, amount=5, in_channel=203, out_channel=232, max_input_channel=32)
        self.op5 = DenseNetUnit(k=20, amount=6, in_channel=232, out_channel=184, max_input_channel=64)
        self.op6 = DenseNetUnit(k=20, amount=6, in_channel=184, out_channel=184, max_input_channel=64)
        self.op8 = DenseNetUnit(k=20, amount=6, in_channel=184, out_channel=184, max_input_channel=64)
