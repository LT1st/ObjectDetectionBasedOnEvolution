...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op4 = DenseNetUnit(k=20, amount=3, in_channel=232, out_channel=124, max_input_channel=64)
        self.op6 = DenseNetUnit(k=20, amount=6, in_channel=124, out_channel=184, max_input_channel=64)
