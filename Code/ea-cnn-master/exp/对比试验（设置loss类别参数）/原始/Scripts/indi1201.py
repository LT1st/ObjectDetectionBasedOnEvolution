...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = DenseNetUnit(k=40, amount=5, in_channel=232, out_channel=232, max_input_channel=32)
        self.op6 = DenseNetUnit(k=20, amount=6, in_channel=232, out_channel=184, max_input_channel=64)
