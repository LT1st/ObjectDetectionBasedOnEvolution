...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=20, amount=10, in_channel=251, out_channel=251, max_input_channel=64)
        self.op3 = ResNetUnit(amount=5, in_channel=251, out_channel=128)
        self.op5 = DenseNetUnit(k=20, amount=6, in_channel=128, out_channel=184, max_input_channel=64)
        self.op7 = ResNetUnit(amount=9, in_channel=184, out_channel=128)
        self.op8 = ResNetUnit(amount=4, in_channel=128, out_channel=64)
        self.op10 = ResNetUnit(amount=7, in_channel=64, out_channel=128)
        self.op11 = ResNetUnit(amount=10, in_channel=128, out_channel=256)
