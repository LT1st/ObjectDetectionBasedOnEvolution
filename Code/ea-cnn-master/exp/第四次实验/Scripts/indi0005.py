...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op5 = DenseNetUnit(k=12, amount=4, in_channel=232, out_channel=176, max_input_channel=128)
        self.op6 = DenseNetUnit(k=40, amount=4, in_channel=176, out_channel=192, max_input_channel=32)
        self.op8 = ResNetUnit(amount=8, in_channel=192, out_channel=64)
        self.op9 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)

        #linear unit
        self.linear = nn.Linear(26496, 6)
