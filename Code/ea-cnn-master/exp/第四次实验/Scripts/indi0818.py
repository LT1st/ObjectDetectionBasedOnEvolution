...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=40, amount=4, in_channel=256, out_channel=192, max_input_channel=32)
        self.op3 = DenseNetUnit(k=20, amount=7, in_channel=192, out_channel=204, max_input_channel=64)
        self.op4 = DenseNetUnit(k=20, amount=7, in_channel=204, out_channel=204, max_input_channel=64)
        self.op5 = DenseNetUnit(k=20, amount=7, in_channel=204, out_channel=204, max_input_channel=64)
        self.op9 = ResNetUnit(amount=3, in_channel=204, out_channel=256)
        self.op10 = DenseNetUnit(k=40, amount=3, in_channel=256, out_channel=152, max_input_channel=32)

        #linear unit
        self.linear = nn.Linear(21888, 6)
