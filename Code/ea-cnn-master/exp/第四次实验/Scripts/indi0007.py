...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = DenseNetUnit(k=12, amount=4, in_channel=232, out_channel=176, max_input_channel=128)
        self.op4 = DenseNetUnit(k=40, amount=4, in_channel=176, out_channel=192, max_input_channel=32)
        self.op6 = ResNetUnit(amount=8, in_channel=192, out_channel=64)
        self.op7 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
        self.op10 = ResNetUnit(amount=9, in_channel=184, out_channel=256)
        self.op11 = DenseNetUnit(k=20, amount=6, in_channel=256, out_channel=184, max_input_channel=64)
        self.op12 = DenseNetUnit(k=12, amount=3, in_channel=184, out_channel=164, max_input_channel=128)
        self.op13 = DenseNetUnit(k=40, amount=4, in_channel=164, out_channel=192, max_input_channel=32)
