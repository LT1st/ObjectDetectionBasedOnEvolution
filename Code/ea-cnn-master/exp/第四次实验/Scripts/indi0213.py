...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=8, in_channel=163, out_channel=64)
        self.op3 = ResNetUnit(amount=5, in_channel=64, out_channel=64)
        self.op4 = ResNetUnit(amount=5, in_channel=64, out_channel=256)
        self.op6 = DenseNetUnit(k=40, amount=4, in_channel=256, out_channel=192, max_input_channel=32)
        self.op7 = DenseNetUnit(k=40, amount=4, in_channel=192, out_channel=192, max_input_channel=32)
        self.op10 = ResNetUnit(amount=5, in_channel=192, out_channel=128)
