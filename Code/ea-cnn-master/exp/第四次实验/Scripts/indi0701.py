...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=8, in_channel=192, out_channel=64)
        self.op5 = DenseNetUnit(k=20, amount=8, in_channel=64, out_channel=224, max_input_channel=64)
        self.op7 = DenseNetUnit(k=40, amount=5, in_channel=224, out_channel=232, max_input_channel=32)
