...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op5 = ResNetUnit(amount=5, in_channel=184, out_channel=256)
        self.op7 = DenseNetUnit(k=40, amount=4, in_channel=256, out_channel=192, max_input_channel=32)
        self.op9 = DenseNetUnit(k=12, amount=6, in_channel=192, out_channel=200, max_input_channel=128)
