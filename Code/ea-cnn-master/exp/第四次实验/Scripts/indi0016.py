...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=8, in_channel=123, out_channel=64)
        self.op2 = DenseNetUnit(k=20, amount=9, in_channel=64, out_channel=244, max_input_channel=64)
        self.op3 = DenseNetUnit(k=12, amount=8, in_channel=244, out_channel=224, max_input_channel=128)
        self.op5 = DenseNetUnit(k=40, amount=4, in_channel=224, out_channel=192, max_input_channel=32)
        self.op8 = ResNetUnit(amount=3, in_channel=192, out_channel=256)
