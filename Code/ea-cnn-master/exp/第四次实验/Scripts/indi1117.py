...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=40, amount=4, in_channel=163, out_channel=163, max_input_channel=32)
        self.op2 = ResNetUnit(amount=8, in_channel=163, out_channel=64)
        ...
        self.op10 = DenseNetUnit(k=12, amount=6, in_channel=256, out_channel=200, max_input_channel=128)
