...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=20, amount=10, in_channel=3, out_channel=203, max_input_channel=64)
        self.op1 = ResNetUnit(amount=5, in_channel=203, out_channel=128)
        self.op3 = DenseNetUnit(k=20, amount=6, in_channel=128, out_channel=184, max_input_channel=64)
        self.op5 = ResNetUnit(amount=9, in_channel=184, out_channel=128)
        self.op6 = ResNetUnit(amount=4, in_channel=128, out_channel=64)
        self.op8 = ResNetUnit(amount=7, in_channel=64, out_channel=128)
        self.op9 = ResNetUnit(amount=10, in_channel=128, out_channel=256)
