...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=10, in_channel=163, out_channel=248, max_input_channel=128)
        self.op3 = DenseNetUnit(k=20, amount=7, in_channel=248, out_channel=204, max_input_channel=64)
