...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=5, in_channel=256, out_channel=64)
        self.op2 = ResNetUnit(amount=5, in_channel=64, out_channel=256)
        self.op3 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op8 = DenseNetUnit(k=12, amount=10, in_channel=232, out_channel=248, max_input_channel=128)
