...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=7, in_channel=128, out_channel=87, max_input_channel=128)
        self.op2 = DenseNetUnit(k=12, amount=5, in_channel=87, out_channel=147, max_input_channel=128)
        self.op4 = ResNetUnit(amount=3, in_channel=147, out_channel=256)
        self.op5 = ResNetUnit(amount=8, in_channel=256, out_channel=64)
        self.op9 = ResNetUnit(amount=5, in_channel=64, out_channel=128)
