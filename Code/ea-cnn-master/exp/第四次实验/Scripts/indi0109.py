...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=12, amount=4, in_channel=3, out_channel=51, max_input_channel=128)
        self.op1 = DenseNetUnit(k=20, amount=10, in_channel=51, out_channel=251, max_input_channel=64)
        self.op2 = ResNetUnit(amount=5, in_channel=251, out_channel=128)
        self.op4 = DenseNetUnit(k=20, amount=6, in_channel=128, out_channel=184, max_input_channel=64)
        self.op6 = ResNetUnit(amount=9, in_channel=184, out_channel=128)
        self.op7 = ResNetUnit(amount=4, in_channel=128, out_channel=64)
        self.op9 = DenseNetUnit(k=12, amount=9, in_channel=64, out_channel=171, max_input_channel=128)
        self.op11 = ResNetUnit(amount=9, in_channel=171, out_channel=256)
        self.op12 = DenseNetUnit(k=20, amount=6, in_channel=256, out_channel=184, max_input_channel=64)
        self.op13 = DenseNetUnit(k=12, amount=3, in_channel=184, out_channel=164, max_input_channel=128)
        self.op14 = DenseNetUnit(k=40, amount=4, in_channel=164, out_channel=192, max_input_channel=32)

        #linear unit
        self.linear = nn.Linear(27648, 6)
