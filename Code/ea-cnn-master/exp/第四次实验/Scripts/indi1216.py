...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op7 = DenseNetUnit(k=40, amount=3, in_channel=232, out_channel=152, max_input_channel=32)
        self.op8 = DenseNetUnit(k=12, amount=6, in_channel=152, out_channel=200, max_input_channel=128)
