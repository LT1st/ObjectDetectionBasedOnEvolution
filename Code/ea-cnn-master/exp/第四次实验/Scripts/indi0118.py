...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op5 = ResNetUnit(amount=7, in_channel=224, out_channel=128)
        self.op7 = ResNetUnit(amount=5, in_channel=128, out_channel=128)
        self.op8 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
