...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op4 = ResNetUnit(amount=3, in_channel=232, out_channel=128)
        self.op7 = ResNetUnit(amount=3, in_channel=128, out_channel=256)
        self.op8 = ResNetUnit(amount=4, in_channel=256, out_channel=64)
