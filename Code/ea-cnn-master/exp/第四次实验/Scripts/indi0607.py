...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=9, in_channel=192, out_channel=256)
        self.op4 = DenseNetUnit(k=20, amount=7, in_channel=256, out_channel=204, max_input_channel=64)
        self.op6 = ResNetUnit(amount=5, in_channel=204, out_channel=64)
        self.op9 = DenseNetUnit(k=40, amount=3, in_channel=64, out_channel=152, max_input_channel=32)
