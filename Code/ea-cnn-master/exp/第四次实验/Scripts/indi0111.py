...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=40, amount=3, in_channel=51, out_channel=123, max_input_channel=32)
        self.op3 = ResNetUnit(amount=5, in_channel=123, out_channel=128)
        self.op4 = ResNetUnit(amount=8, in_channel=128, out_channel=256)
        self.op5 = DenseNetUnit(k=12, amount=7, in_channel=256, out_channel=212, max_input_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=4, in_channel=212, out_channel=176, max_input_channel=128)
        self.op9 = ResNetUnit(amount=7, in_channel=176, out_channel=128)
        self.op11 = ResNetUnit(amount=9, in_channel=128, out_channel=64)
