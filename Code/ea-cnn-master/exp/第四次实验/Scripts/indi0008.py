...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = ResNetUnit(amount=5, in_channel=123, out_channel=128)
        self.op3 = ResNetUnit(amount=8, in_channel=128, out_channel=256)
        self.op4 = DenseNetUnit(k=12, amount=7, in_channel=256, out_channel=212, max_input_channel=128)
        self.op7 = DenseNetUnit(k=12, amount=4, in_channel=212, out_channel=176, max_input_channel=128)
        self.op8 = ResNetUnit(amount=7, in_channel=176, out_channel=128)
        self.op10 = ResNetUnit(amount=9, in_channel=128, out_channel=64)
