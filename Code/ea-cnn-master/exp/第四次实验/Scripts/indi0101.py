...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=5, in_channel=51, out_channel=128)
        ...
        self.op7 = ResNetUnit(amount=8, in_channel=192, out_channel=64)
        self.op8 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
