...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op4 = ResNetUnit(amount=9, in_channel=64, out_channel=128)
        self.op5 = ResNetUnit(amount=4, in_channel=128, out_channel=64)
        self.op7 = ResNetUnit(amount=7, in_channel=64, out_channel=128)
        self.op8 = ResNetUnit(amount=10, in_channel=128, out_channel=256)
