...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = ResNetUnit(amount=4, in_channel=143, out_channel=256)
        self.op3 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op4 = ResNetUnit(amount=7, in_channel=232, out_channel=128)
        self.op5 = DenseNetUnit(k=40, amount=4, in_channel=128, out_channel=192, max_input_channel=32)
        self.op7 = DenseNetUnit(k=40, amount=4, in_channel=192, out_channel=192, max_input_channel=32)
        self.op9 = DenseNetUnit(k=20, amount=7, in_channel=192, out_channel=204, max_input_channel=64)
        self.op10 = ResNetUnit(amount=5, in_channel=204, out_channel=64)
