...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = ResNetUnit(amount=5, in_channel=163, out_channel=64)
        self.op5 = DenseNetUnit(k=12, amount=9, in_channel=64, out_channel=171, max_input_channel=128)
        self.op7 = ResNetUnit(amount=9, in_channel=171, out_channel=256)
        self.op8 = DenseNetUnit(k=20, amount=6, in_channel=256, out_channel=184, max_input_channel=64)
        self.op9 = DenseNetUnit(k=12, amount=3, in_channel=184, out_channel=164, max_input_channel=128)
        self.op10 = DenseNetUnit(k=40, amount=4, in_channel=164, out_channel=192, max_input_channel=32)
