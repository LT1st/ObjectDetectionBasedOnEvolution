...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = ResNetUnit(amount=5, in_channel=87, out_channel=64)
        ...
        self.op7 = DenseNetUnit(k=12, amount=6, in_channel=192, out_channel=200, max_input_channel=128)

        #linear unit
        self.linear = nn.Linear(125000, 6)
