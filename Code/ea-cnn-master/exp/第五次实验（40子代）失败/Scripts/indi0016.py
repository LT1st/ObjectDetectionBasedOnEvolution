...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = DenseNetUnit(k=12, amount=9, in_channel=128, out_channel=236, max_input_channel=128)
        self.op4 = DenseNetUnit(k=40, amount=3, in_channel=236, out_channel=152, max_input_channel=32)
        self.op5 = ResNetUnit(amount=9, in_channel=152, out_channel=256)
        self.op8 = ResNetUnit(amount=8, in_channel=256, out_channel=128)
