...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=40, amount=4, in_channel=163, out_channel=192, max_input_channel=32)
        self.op4 = ResNetUnit(amount=3, in_channel=192, out_channel=256)
        self.op5 = ResNetUnit(amount=5, in_channel=256, out_channel=64)
        self.op6 = DenseNetUnit(k=12, amount=6, in_channel=64, out_channel=136, max_input_channel=128)
        self.op7 = DenseNetUnit(k=12, amount=3, in_channel=136, out_channel=164, max_input_channel=128)
