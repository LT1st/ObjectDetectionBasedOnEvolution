...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=10, in_channel=256, out_channel=248, max_input_channel=128)
        self.op2 = DenseNetUnit(k=40, amount=3, in_channel=248, out_channel=152, max_input_channel=32)
        self.op5 = ResNetUnit(amount=9, in_channel=152, out_channel=256)
        self.op8 = DenseNetUnit(k=40, amount=3, in_channel=256, out_channel=152, max_input_channel=32)
