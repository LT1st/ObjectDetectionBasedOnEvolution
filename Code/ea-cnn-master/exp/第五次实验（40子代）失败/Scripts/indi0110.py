...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=5, in_channel=39, out_channel=256)
        self.op3 = DenseNetUnit(k=12, amount=9, in_channel=256, out_channel=236, max_input_channel=128)
        self.op6 = DenseNetUnit(k=20, amount=9, in_channel=236, out_channel=244, max_input_channel=64)

        #linear unit
        self.linear = nn.Linear(152500, 6)
