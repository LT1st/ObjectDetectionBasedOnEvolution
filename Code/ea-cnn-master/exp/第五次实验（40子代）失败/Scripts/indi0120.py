...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op8 = ResNetUnit(amount=3, in_channel=256, out_channel=256)
        self.op9 = ResNetUnit(amount=5, in_channel=256, out_channel=64)
        self.op10 = ResNetUnit(amount=6, in_channel=64, out_channel=128)
