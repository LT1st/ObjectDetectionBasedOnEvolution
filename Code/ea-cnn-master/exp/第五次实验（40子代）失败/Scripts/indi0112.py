...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=5, in_channel=3, out_channel=128)
        self.op3 = DenseNetUnit(k=20, amount=3, in_channel=128, out_channel=124, max_input_channel=64)
        self.op4 = ResNetUnit(amount=3, in_channel=124, out_channel=128)
        self.op5 = DenseNetUnit(k=12, amount=10, in_channel=128, out_channel=248, max_input_channel=128)
        self.op6 = DenseNetUnit(k=20, amount=5, in_channel=248, out_channel=164, max_input_channel=64)
        self.op7 = ResNetUnit(amount=6, in_channel=164, out_channel=256)
        self.op9 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op11 = ResNetUnit(amount=4, in_channel=232, out_channel=64)
        self.op12 = ResNetUnit(amount=5, in_channel=64, out_channel=64)
        self.op13 = DenseNetUnit(k=40, amount=4, in_channel=64, out_channel=192, max_input_channel=32)
        self.op14 = ResNetUnit(amount=7, in_channel=192, out_channel=128)
