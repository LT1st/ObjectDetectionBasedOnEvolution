...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=40, amount=5, in_channel=143, out_channel=232, max_input_channel=32)
        self.op4 = DenseNetUnit(k=12, amount=6, in_channel=232, out_channel=200, max_input_channel=128)
        self.op5 = DenseNetUnit(k=12, amount=3, in_channel=200, out_channel=164, max_input_channel=128)
        self.op8 = ResNetUnit(amount=10, in_channel=164, out_channel=64)
        self.op9 = ResNetUnit(amount=3, in_channel=64, out_channel=256)
        self.op10 = DenseNetUnit(k=20, amount=5, in_channel=256, out_channel=164, max_input_channel=64)
        self.op11 = ResNetUnit(amount=8, in_channel=164, out_channel=256)
        self.op12 = DenseNetUnit(k=20, amount=8, in_channel=256, out_channel=224, max_input_channel=64)
