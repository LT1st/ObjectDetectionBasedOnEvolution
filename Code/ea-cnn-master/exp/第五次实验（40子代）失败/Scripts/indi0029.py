...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=20, amount=8, in_channel=128, out_channel=224, max_input_channel=64)
        self.op2 = DenseNetUnit(k=20, amount=9, in_channel=224, out_channel=244, max_input_channel=64)
        self.op3 = DenseNetUnit(k=12, amount=5, in_channel=244, out_channel=188, max_input_channel=128)
        self.op4 = ResNetUnit(amount=7, in_channel=188, out_channel=256)
        self.op5 = ResNetUnit(amount=3, in_channel=256, out_channel=256)
        self.op6 = ResNetUnit(amount=5, in_channel=256, out_channel=256)
        self.op7 = DenseNetUnit(k=20, amount=7, in_channel=256, out_channel=204, max_input_channel=64)

        #linear unit
        self.linear = nn.Linear(29376, 6)
