...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op5 = DenseNetUnit(k=40, amount=5, in_channel=64, out_channel=232, max_input_channel=32)
        self.op7 = ResNetUnit(amount=4, in_channel=232, out_channel=64)
        self.op8 = ResNetUnit(amount=5, in_channel=64, out_channel=64)
        self.op9 = DenseNetUnit(k=40, amount=4, in_channel=64, out_channel=192, max_input_channel=32)
        self.op10 = ResNetUnit(amount=7, in_channel=192, out_channel=128)
