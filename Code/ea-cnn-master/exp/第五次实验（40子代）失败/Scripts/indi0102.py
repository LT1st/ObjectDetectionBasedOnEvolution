...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=20, amount=3, in_channel=256, out_channel=124, max_input_channel=64)
        ...
        self.op9 = DenseNetUnit(k=40, amount=3, in_channel=232, out_channel=152, max_input_channel=32)
