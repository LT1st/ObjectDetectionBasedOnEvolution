...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=4, in_channel=3, out_channel=128)
        self.op1 = ResNetUnit(amount=5, in_channel=128, out_channel=128)
        self.op2 = DenseNetUnit(k=20, amount=7, in_channel=128, out_channel=143, max_input_channel=64)
        self.op3 = DenseNetUnit(k=20, amount=4, in_channel=143, out_channel=144, max_input_channel=64)
        self.op4 = DenseNetUnit(k=20, amount=10, in_channel=144, out_channel=264, max_input_channel=64)
        self.op7 = ResNetUnit(amount=7, in_channel=264, out_channel=256)
        self.op9 = DenseNetUnit(k=12, amount=7, in_channel=256, out_channel=212, max_input_channel=128)
