...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=10, in_channel=3, out_channel=64)
        self.op2 = DenseNetUnit(k=40, amount=5, in_channel=64, out_channel=232, max_input_channel=32)
        ...
        self.op9 = DenseNetUnit(k=12, amount=4, in_channel=144, out_channel=176, max_input_channel=128)

        #linear unit
        self.linear = nn.Linear(25344, 6)
