...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=8, in_channel=64, out_channel=256)
        self.op4 = DenseNetUnit(k=12, amount=4, in_channel=256, out_channel=112, max_input_channel=128)
        self.op7 = DenseNetUnit(k=20, amount=6, in_channel=112, out_channel=184, max_input_channel=64)
        self.op8 = ResNetUnit(amount=9, in_channel=184, out_channel=128)
        self.op9 = DenseNetUnit(k=40, amount=5, in_channel=128, out_channel=232, max_input_channel=32)
