...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=20, amount=8, in_channel=143, out_channel=224, max_input_channel=64)
        self.op3 = DenseNetUnit(k=20, amount=3, in_channel=224, out_channel=124, max_input_channel=64)
        self.op5 = ResNetUnit(amount=5, in_channel=124, out_channel=128)
        self.op6 = DenseNetUnit(k=12, amount=5, in_channel=128, out_channel=188, max_input_channel=128)
        self.op7 = DenseNetUnit(k=12, amount=8, in_channel=188, out_channel=224, max_input_channel=128)
        self.op8 = ResNetUnit(amount=9, in_channel=224, out_channel=128)
        self.op10 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
        self.op12 = ResNetUnit(amount=9, in_channel=152, out_channel=128)
