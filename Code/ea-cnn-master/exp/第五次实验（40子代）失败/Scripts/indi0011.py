...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=4, in_channel=3, out_channel=64)
        self.op3 = DenseNetUnit(k=20, amount=4, in_channel=64, out_channel=144, max_input_channel=64)
        self.op4 = ResNetUnit(amount=9, in_channel=144, out_channel=128)
        self.op5 = ResNetUnit(amount=7, in_channel=128, out_channel=256)
        self.op6 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op7 = DenseNetUnit(k=12, amount=5, in_channel=232, out_channel=188, max_input_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=7, in_channel=188, out_channel=212, max_input_channel=128)
        self.op9 = ResNetUnit(amount=3, in_channel=212, out_channel=64)
