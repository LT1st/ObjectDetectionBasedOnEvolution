...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=20, amount=7, in_channel=83, out_channel=204, max_input_channel=64)
        self.op2 = ResNetUnit(amount=3, in_channel=204, out_channel=256)
        self.op4 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op6 = DenseNetUnit(k=12, amount=6, in_channel=232, out_channel=200, max_input_channel=128)
        self.op7 = DenseNetUnit(k=12, amount=3, in_channel=200, out_channel=164, max_input_channel=128)
        self.op10 = ResNetUnit(amount=10, in_channel=164, out_channel=64)
        self.op11 = ResNetUnit(amount=3, in_channel=64, out_channel=256)
        self.op12 = DenseNetUnit(k=20, amount=5, in_channel=256, out_channel=164, max_input_channel=64)
        self.op13 = ResNetUnit(amount=8, in_channel=164, out_channel=256)
        self.op14 = DenseNetUnit(k=20, amount=8, in_channel=256, out_channel=224, max_input_channel=64)
