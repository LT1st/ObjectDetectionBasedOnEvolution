...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=5, in_channel=256, out_channel=124, max_input_channel=128)
        self.op2 = ResNetUnit(amount=6, in_channel=124, out_channel=128)
        self.op4 = ResNetUnit(amount=10, in_channel=128, out_channel=256)
        self.op5 = ResNetUnit(amount=10, in_channel=256, out_channel=128)
        self.op6 = DenseNetUnit(k=12, amount=3, in_channel=128, out_channel=164, max_input_channel=128)
