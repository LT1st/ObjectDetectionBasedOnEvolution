...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=4, in_channel=256, out_channel=176, max_input_channel=128)
        self.op4 = ResNetUnit(amount=3, in_channel=176, out_channel=256)
        self.op5 = ResNetUnit(amount=5, in_channel=256, out_channel=64)
        self.op8 = DenseNetUnit(k=12, amount=3, in_channel=64, out_channel=100, max_input_channel=128)
        self.op9 = DenseNetUnit(k=12, amount=5, in_channel=100, out_channel=160, max_input_channel=128)
        self.op10 = DenseNetUnit(k=12, amount=5, in_channel=160, out_channel=188, max_input_channel=128)
