...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=20, amount=10, in_channel=64, out_channel=264, max_input_channel=64)
        self.op5 = ResNetUnit(amount=4, in_channel=264, out_channel=64)
        self.op6 = ResNetUnit(amount=7, in_channel=64, out_channel=128)
