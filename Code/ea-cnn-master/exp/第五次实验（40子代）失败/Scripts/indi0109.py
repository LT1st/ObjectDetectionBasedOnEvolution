...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op7 = DenseNetUnit(k=12, amount=3, in_channel=64, out_channel=100, max_input_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=5, in_channel=100, out_channel=160, max_input_channel=128)
        self.op9 = DenseNetUnit(k=12, amount=5, in_channel=160, out_channel=188, max_input_channel=128)
