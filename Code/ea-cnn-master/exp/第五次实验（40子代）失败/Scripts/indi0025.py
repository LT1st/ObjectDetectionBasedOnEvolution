...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=3, in_channel=3, out_channel=256)
        self.op1 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op3 = DenseNetUnit(k=12, amount=6, in_channel=232, out_channel=200, max_input_channel=128)
        self.op4 = DenseNetUnit(k=12, amount=3, in_channel=200, out_channel=164, max_input_channel=128)
        self.op7 = ResNetUnit(amount=10, in_channel=164, out_channel=64)
        self.op8 = ResNetUnit(amount=3, in_channel=64, out_channel=256)
        self.op9 = DenseNetUnit(k=20, amount=5, in_channel=256, out_channel=164, max_input_channel=64)
        self.op10 = DenseNetUnit(k=12, amount=3, in_channel=164, out_channel=100, max_input_channel=128)
        self.op11 = DenseNetUnit(k=12, amount=5, in_channel=100, out_channel=160, max_input_channel=128)
        self.op12 = DenseNetUnit(k=12, amount=5, in_channel=160, out_channel=188, max_input_channel=128)

        #linear unit
        self.linear = nn.Linear(117500, 6)
