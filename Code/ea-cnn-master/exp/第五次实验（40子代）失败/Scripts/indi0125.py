...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op6 = ResNetUnit(amount=8, in_channel=188, out_channel=64)
        self.op7 = ResNetUnit(amount=5, in_channel=64, out_channel=64)
        self.op8 = ResNetUnit(amount=10, in_channel=64, out_channel=256)
