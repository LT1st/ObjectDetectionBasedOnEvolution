...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=6, in_channel=163, out_channel=128)
        self.op5 = ResNetUnit(amount=5, in_channel=128, out_channel=128)
        self.op7 = DenseNetUnit(k=20, amount=10, in_channel=128, out_channel=264, max_input_channel=64)
        self.op8 = DenseNetUnit(k=12, amount=3, in_channel=264, out_channel=164, max_input_channel=128)
        self.op9 = DenseNetUnit(k=20, amount=3, in_channel=164, out_channel=124, max_input_channel=64)

        #linear unit
        self.linear = nn.Linear(17856, 6)
