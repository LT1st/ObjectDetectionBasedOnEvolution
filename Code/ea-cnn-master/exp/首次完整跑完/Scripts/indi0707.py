...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op4 = ResNetUnit(amount=10, in_channel=184, out_channel=128)
        self.op5 = ResNetUnit(amount=6, in_channel=128, out_channel=128)
        self.op6 = DenseNetUnit(k=12, amount=10, in_channel=128, out_channel=248, max_input_channel=128)
        self.op9 = DenseNetUnit(k=12, amount=9, in_channel=248, out_channel=236, max_input_channel=128)
