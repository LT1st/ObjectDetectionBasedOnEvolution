...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=12, amount=3, in_channel=3, out_channel=39, max_input_channel=128)
        self.op1 = ResNetUnit(amount=5, in_channel=39, out_channel=128)
        self.op2 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
        self.op5 = DenseNetUnit(k=12, amount=8, in_channel=152, out_channel=224, max_input_channel=128)
        self.op6 = ResNetUnit(amount=4, in_channel=224, out_channel=256)
        self.op8 = DenseNetUnit(k=12, amount=7, in_channel=256, out_channel=212, max_input_channel=128)
        self.op9 = ResNetUnit(amount=7, in_channel=212, out_channel=64)
        self.op10 = ResNetUnit(amount=9, in_channel=64, out_channel=128)
