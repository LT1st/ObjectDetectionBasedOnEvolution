...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op9 = ResNetUnit(amount=4, in_channel=128, out_channel=128)
        self.op10 = DenseNetUnit(k=20, amount=9, in_channel=128, out_channel=244, max_input_channel=64)
        self.op11 = ResNetUnit(amount=9, in_channel=244, out_channel=256)
        self.op12 = ResNetUnit(amount=4, in_channel=256, out_channel=128)
