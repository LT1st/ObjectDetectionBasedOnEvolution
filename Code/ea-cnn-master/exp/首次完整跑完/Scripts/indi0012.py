...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=20, amount=6, in_channel=75, out_channel=184, max_input_channel=64)
        self.op3 = ResNetUnit(amount=4, in_channel=184, out_channel=64)
        self.op5 = ResNetUnit(amount=8, in_channel=64, out_channel=128)
        self.op6 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
