...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op5 = DenseNetUnit(k=12, amount=10, in_channel=248, out_channel=184, max_input_channel=128)
        self.op7 = ResNetUnit(amount=9, in_channel=184, out_channel=128)
        self.op9 = DenseNetUnit(k=20, amount=9, in_channel=128, out_channel=244, max_input_channel=64)
        self.op10 = ResNetUnit(amount=9, in_channel=244, out_channel=256)
        self.op11 = ResNetUnit(amount=4, in_channel=256, out_channel=128)
