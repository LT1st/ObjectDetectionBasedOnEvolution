...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=20, amount=8, in_channel=63, out_channel=223, max_input_channel=64)
        self.op2 = DenseNetUnit(k=20, amount=7, in_channel=223, out_channel=204, max_input_channel=64)
        self.op4 = ResNetUnit(amount=9, in_channel=204, out_channel=256)
        self.op6 = DenseNetUnit(k=40, amount=3, in_channel=256, out_channel=152, max_input_channel=32)
        self.op8 = ResNetUnit(amount=5, in_channel=152, out_channel=64)
