...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
        self.op2 = ResNetUnit(amount=6, in_channel=184, out_channel=256)
        self.op3 = ResNetUnit(amount=5, in_channel=256, out_channel=256)
        self.op5 = DenseNetUnit(k=20, amount=5, in_channel=256, out_channel=164, max_input_channel=64)
        self.op9 = DenseNetUnit(k=40, amount=5, in_channel=164, out_channel=232, max_input_channel=32)
        self.op10 = ResNetUnit(amount=3, in_channel=232, out_channel=256)
