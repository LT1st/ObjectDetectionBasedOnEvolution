...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op4 = DenseNetUnit(k=12, amount=7, in_channel=64, out_channel=148, max_input_channel=128)
        self.op6 = DenseNetUnit(k=12, amount=6, in_channel=148, out_channel=200, max_input_channel=128)
