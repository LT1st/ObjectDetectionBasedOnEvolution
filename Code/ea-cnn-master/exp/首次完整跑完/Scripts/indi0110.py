...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=40, amount=4, in_channel=163, out_channel=192, max_input_channel=32)
        self.op3 = ResNetUnit(amount=9, in_channel=192, out_channel=64)
        self.op4 = ResNetUnit(amount=3, in_channel=64, out_channel=256)
        self.op6 = ResNetUnit(amount=10, in_channel=256, out_channel=128)
