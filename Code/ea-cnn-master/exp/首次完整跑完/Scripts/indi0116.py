...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=9, in_channel=123, out_channel=231, max_input_channel=128)
        self.op4 = DenseNetUnit(k=12, amount=8, in_channel=231, out_channel=224, max_input_channel=128)
