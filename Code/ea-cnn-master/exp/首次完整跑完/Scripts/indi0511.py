...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=9, in_channel=64, out_channel=64)
        self.op3 = ResNetUnit(amount=7, in_channel=64, out_channel=64)
        self.op5 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
        self.op6 = ResNetUnit(amount=10, in_channel=184, out_channel=128)
        self.op7 = ResNetUnit(amount=6, in_channel=128, out_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=10, in_channel=128, out_channel=248, max_input_channel=128)
        self.op9 = ResNetUnit(amount=10, in_channel=248, out_channel=128)
        self.op10 = ResNetUnit(amount=6, in_channel=128, out_channel=128)
        self.op11 = DenseNetUnit(k=12, amount=10, in_channel=128, out_channel=248, max_input_channel=128)
        self.op14 = DenseNetUnit(k=12, amount=9, in_channel=248, out_channel=236, max_input_channel=128)

        #linear unit
        self.linear = nn.Linear(33984, 6)
