...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = DenseNetUnit(k=12, amount=8, in_channel=75, out_channel=171, max_input_channel=128)
        self.op4 = ResNetUnit(amount=4, in_channel=171, out_channel=256)
        self.op6 = DenseNetUnit(k=12, amount=7, in_channel=256, out_channel=212, max_input_channel=128)
        self.op7 = ResNetUnit(amount=7, in_channel=212, out_channel=64)
        self.op8 = ResNetUnit(amount=9, in_channel=64, out_channel=128)
