...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=7, in_channel=203, out_channel=64)
        self.op2 = DenseNetUnit(k=12, amount=9, in_channel=64, out_channel=172, max_input_channel=128)
        self.op3 = DenseNetUnit(k=20, amount=7, in_channel=172, out_channel=204, max_input_channel=64)
        self.op5 = ResNetUnit(amount=9, in_channel=204, out_channel=256)
        self.op7 = DenseNetUnit(k=40, amount=3, in_channel=256, out_channel=152, max_input_channel=32)
        self.op9 = ResNetUnit(amount=5, in_channel=152, out_channel=64)
        self.op11 = ResNetUnit(amount=9, in_channel=64, out_channel=64)
        self.op12 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
        self.op13 = ResNetUnit(amount=6, in_channel=184, out_channel=64)
