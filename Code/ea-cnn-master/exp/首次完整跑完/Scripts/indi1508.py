...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op4 = ResNetUnit(amount=10, in_channel=248, out_channel=256)
        self.op6 = DenseNetUnit(k=12, amount=10, in_channel=256, out_channel=248, max_input_channel=128)
        self.op8 = ResNetUnit(amount=5, in_channel=248, out_channel=64)
        self.op9 = ResNetUnit(amount=9, in_channel=64, out_channel=128)
