...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=12, amount=5, in_channel=3, out_channel=63, max_input_channel=128)
        self.op1 = ResNetUnit(amount=4, in_channel=63, out_channel=64)
        self.op4 = ResNetUnit(amount=6, in_channel=64, out_channel=128)
        self.op5 = DenseNetUnit(k=12, amount=10, in_channel=128, out_channel=248, max_input_channel=128)
        self.op8 = ResNetUnit(amount=9, in_channel=248, out_channel=64)
        self.op9 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
        self.op10 = ResNetUnit(amount=6, in_channel=184, out_channel=64)
