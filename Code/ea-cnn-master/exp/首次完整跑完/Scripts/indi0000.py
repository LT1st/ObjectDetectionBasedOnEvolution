...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=5, in_channel=183, out_channel=256)
        self.op3 = DenseNetUnit(k=20, amount=5, in_channel=256, out_channel=164, max_input_channel=64)
        self.op6 = ResNetUnit(amount=10, in_channel=164, out_channel=128)
        self.op7 = DenseNetUnit(k=20, amount=6, in_channel=128, out_channel=184, max_input_channel=64)
