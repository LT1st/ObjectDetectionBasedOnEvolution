...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=9, in_channel=3, out_channel=64)
        self.op2 = ResNetUnit(amount=3, in_channel=64, out_channel=128)
        self.op3 = ResNetUnit(amount=7, in_channel=128, out_channel=64)
        self.op6 = ResNetUnit(amount=9, in_channel=64, out_channel=128)
        self.op7 = DenseNetUnit(k=20, amount=8, in_channel=128, out_channel=224, max_input_channel=64)
