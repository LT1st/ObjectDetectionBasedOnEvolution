...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op4 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
        self.op5 = DenseNetUnit(k=12, amount=10, in_channel=184, out_channel=184, max_input_channel=128)
