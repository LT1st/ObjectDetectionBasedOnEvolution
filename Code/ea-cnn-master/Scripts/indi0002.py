...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=10, in_channel=204, out_channel=128)
        self.op4 = DenseNetUnit(k=20, amount=8, in_channel=128, out_channel=224, max_input_channel=64)
        self.op7 = ResNetUnit(amount=5, in_channel=224, out_channel=128)
        self.op8 = ResNetUnit(amount=7, in_channel=128, out_channel=128)
        self.op10 = DenseNetUnit(k=12, amount=10, in_channel=128, out_channel=248, max_input_channel=128)
        self.op11 = ResNetUnit(amount=7, in_channel=248, out_channel=128)
