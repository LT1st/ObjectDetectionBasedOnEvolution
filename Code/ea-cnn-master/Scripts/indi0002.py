...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=9, in_channel=172, out_channel=64)
        self.op5 = DenseNetUnit(k=20, amount=9, in_channel=64, out_channel=244, max_input_channel=64)
        self.op8 = ResNetUnit(amount=6, in_channel=244, out_channel=256)
        self.op9 = DenseNetUnit(k=20, amount=10, in_channel=256, out_channel=264, max_input_channel=64)
        self.op10 = DenseNetUnit(k=12, amount=9, in_channel=264, out_channel=236, max_input_channel=128)
