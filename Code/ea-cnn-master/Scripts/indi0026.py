...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=6, in_channel=256, out_channel=256)
        self.op3 = ResNetUnit(amount=9, in_channel=256, out_channel=256)
        self.op4 = ResNetUnit(amount=6, in_channel=256, out_channel=128)
        self.op5 = DenseNetUnit(k=40, amount=4, in_channel=128, out_channel=192, max_input_channel=32)
        self.op7 = ResNetUnit(amount=6, in_channel=192, out_channel=128)
        self.op8 = DenseNetUnit(k=20, amount=10, in_channel=128, out_channel=264, max_input_channel=64)
        self.op10 = ResNetUnit(amount=10, in_channel=264, out_channel=128)
