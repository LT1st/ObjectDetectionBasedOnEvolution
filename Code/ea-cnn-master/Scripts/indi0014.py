...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=3, in_channel=163, out_channel=64)
        self.op4 = DenseNetUnit(k=12, amount=9, in_channel=64, out_channel=172, max_input_channel=128)
        self.op6 = DenseNetUnit(k=12, amount=10, in_channel=172, out_channel=248, max_input_channel=128)
