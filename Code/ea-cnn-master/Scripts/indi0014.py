...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=12, amount=7, in_channel=3, out_channel=87, max_input_channel=128)
        self.op1 = DenseNetUnit(k=12, amount=7, in_channel=87, out_channel=171, max_input_channel=128)
        self.op2 = DenseNetUnit(k=12, amount=5, in_channel=171, out_channel=188, max_input_channel=128)
        self.op4 = DenseNetUnit(k=12, amount=8, in_channel=188, out_channel=224, max_input_channel=128)
        self.op5 = ResNetUnit(amount=11, in_channel=224, out_channel=128)
        self.op7 = ResNetUnit(amount=9, in_channel=128, out_channel=64)
