...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=20, amount=6, in_channel=3, out_channel=123, max_input_channel=64)
        self.op1 = ResNetUnit(amount=3, in_channel=123, out_channel=256)
        self.op3 = DenseNetUnit(k=12, amount=7, in_channel=256, out_channel=212, max_input_channel=128)
        self.op4 = ResNetUnit(amount=4, in_channel=212, out_channel=64)
        self.op5 = ResNetUnit(amount=4, in_channel=64, out_channel=128)
        self.op6 = ResNetUnit(amount=10, in_channel=128, out_channel=64)
        self.op9 = DenseNetUnit(k=20, amount=9, in_channel=64, out_channel=244, max_input_channel=64)
