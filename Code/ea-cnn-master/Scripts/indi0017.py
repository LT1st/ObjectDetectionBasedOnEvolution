...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=40, amount=5, in_channel=163, out_channel=232, max_input_channel=32)
        self.op3 = ResNetUnit(amount=6, in_channel=232, out_channel=256)
        self.op7 = ResNetUnit(amount=8, in_channel=256, out_channel=64)
