...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=6, in_channel=143, out_channel=128)
        self.op3 = DenseNetUnit(k=20, amount=10, in_channel=128, out_channel=264, max_input_channel=64)
        self.op4 = ResNetUnit(amount=5, in_channel=264, out_channel=64)
        self.op6 = DenseNetUnit(k=20, amount=7, in_channel=64, out_channel=204, max_input_channel=64)
        self.op9 = ResNetUnit(amount=8, in_channel=204, out_channel=64)
