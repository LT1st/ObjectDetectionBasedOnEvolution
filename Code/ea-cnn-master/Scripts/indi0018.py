...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=12, amount=3, in_channel=203, out_channel=164, max_input_channel=128)
        self.op3 = ResNetUnit(amount=9, in_channel=164, out_channel=64)
        self.op5 = ResNetUnit(amount=4, in_channel=64, out_channel=256)
        self.op7 = DenseNetUnit(k=20, amount=5, in_channel=256, out_channel=164, max_input_channel=64)
        self.op8 = ResNetUnit(amount=3, in_channel=164, out_channel=128)
        self.op10 = DenseNetUnit(k=40, amount=4, in_channel=128, out_channel=192, max_input_channel=32)
