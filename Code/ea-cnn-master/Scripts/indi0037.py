...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=6, in_channel=123, out_channel=75, max_input_channel=128)
        self.op2 = ResNetUnit(amount=9, in_channel=75, out_channel=64)
        self.op3 = ResNetUnit(amount=6, in_channel=64, out_channel=128)
        self.op5 = DenseNetUnit(k=20, amount=10, in_channel=128, out_channel=264, max_input_channel=64)
        self.op6 = ResNetUnit(amount=5, in_channel=264, out_channel=64)
        self.op8 = DenseNetUnit(k=20, amount=7, in_channel=64, out_channel=204, max_input_channel=64)
        self.op11 = DenseNetUnit(k=12, amount=7, in_channel=204, out_channel=212, max_input_channel=128)
        self.op12 = ResNetUnit(amount=8, in_channel=212, out_channel=64)
