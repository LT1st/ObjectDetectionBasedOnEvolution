...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=9, in_channel=3, out_channel=256)
        self.op2 = ResNetUnit(amount=7, in_channel=256, out_channel=256)
        self.op5 = ResNetUnit(amount=10, in_channel=256, out_channel=64)
        self.op7 = DenseNetUnit(k=12, amount=5, in_channel=64, out_channel=124, max_input_channel=128)
