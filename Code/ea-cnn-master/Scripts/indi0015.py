...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=11, in_channel=3, out_channel=256)
        self.op2 = ResNetUnit(amount=5, in_channel=256, out_channel=64)
        self.op4 = ResNetUnit(amount=4, in_channel=64, out_channel=256)
        self.op6 = ResNetUnit(amount=3, in_channel=256, out_channel=64)
        self.op8 = DenseNetUnit(k=12, amount=10, in_channel=64, out_channel=184, max_input_channel=128)
        self.op9 = ResNetUnit(amount=7, in_channel=184, out_channel=256)
