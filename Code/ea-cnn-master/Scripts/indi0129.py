...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=12, amount=4, in_channel=232, out_channel=176, max_input_channel=128)
        self.op5 = DenseNetUnit(k=12, amount=3, in_channel=176, out_channel=164, max_input_channel=128)
        self.op8 = DenseNetUnit(k=40, amount=3, in_channel=164, out_channel=152, max_input_channel=32)
        self.op9 = DenseNetUnit(k=20, amount=9, in_channel=152, out_channel=244, max_input_channel=64)
