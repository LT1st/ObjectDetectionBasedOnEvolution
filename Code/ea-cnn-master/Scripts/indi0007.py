...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=12, in_channel=3, out_channel=256)
        self.op2 = ResNetUnit(amount=6, in_channel=256, out_channel=256)
        self.op4 = DenseNetUnit(k=20, amount=4, in_channel=256, out_channel=144, max_input_channel=64)
        self.op7 = ResNetUnit(amount=12, in_channel=144, out_channel=128)
