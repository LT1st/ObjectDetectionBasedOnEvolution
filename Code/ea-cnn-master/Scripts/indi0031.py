...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=7, in_channel=143, out_channel=256)
        self.op4 = DenseNetUnit(k=20, amount=10, in_channel=256, out_channel=264, max_input_channel=64)
        self.op5 = ResNetUnit(amount=6, in_channel=264, out_channel=64)
        self.op8 = DenseNetUnit(k=40, amount=5, in_channel=64, out_channel=232, max_input_channel=32)
