...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=4, in_channel=3, out_channel=256)
        self.op2 = ResNetUnit(amount=4, in_channel=256, out_channel=64)
        self.op3 = DenseNetUnit(k=12, amount=4, in_channel=64, out_channel=112, max_input_channel=128)
        self.op4 = DenseNetUnit(k=12, amount=3, in_channel=112, out_channel=148, max_input_channel=128)
        self.op5 = ResNetUnit(amount=5, in_channel=148, out_channel=256)
        self.op7 = DenseNetUnit(k=12, amount=9, in_channel=256, out_channel=236, max_input_channel=128)
        self.op9 = DenseNetUnit(k=40, amount=5, in_channel=236, out_channel=232, max_input_channel=32)
        self.op10 = DenseNetUnit(k=40, amount=3, in_channel=232, out_channel=152, max_input_channel=32)

        #linear unit
        self.linear = nn.Linear(95000, 6)
