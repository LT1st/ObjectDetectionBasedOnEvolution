...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=8, in_channel=64, out_channel=64)
        self.op7 = ResNetUnit(amount=3, in_channel=64, out_channel=64)
        self.op8 = DenseNetUnit(k=12, amount=7, in_channel=64, out_channel=148, max_input_channel=128)
        self.op9 = DenseNetUnit(k=40, amount=4, in_channel=148, out_channel=192, max_input_channel=32)
        self.op10 = DenseNetUnit(k=12, amount=9, in_channel=192, out_channel=236, max_input_channel=128)
