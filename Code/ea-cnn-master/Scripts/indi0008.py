...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=6, in_channel=3, out_channel=128)
        self.op2 = DenseNetUnit(k=12, amount=6, in_channel=128, out_channel=200, max_input_channel=128)
        self.op6 = ResNetUnit(amount=10, in_channel=200, out_channel=256)
        self.op7 = ResNetUnit(amount=5, in_channel=256, out_channel=256)
        self.op8 = ResNetUnit(amount=7, in_channel=256, out_channel=256)
