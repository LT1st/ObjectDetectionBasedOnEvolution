...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=20, amount=10, in_channel=63, out_channel=263, max_input_channel=64)
        self.op5 = DenseNetUnit(k=40, amount=3, in_channel=263, out_channel=152, max_input_channel=32)
        self.op6 = ResNetUnit(amount=6, in_channel=152, out_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=7, in_channel=128, out_channel=212, max_input_channel=128)
