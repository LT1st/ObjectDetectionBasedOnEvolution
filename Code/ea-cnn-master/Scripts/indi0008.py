...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=5, in_channel=3, out_channel=256)
        self.op1 = ResNetUnit(amount=5, in_channel=256, out_channel=256)
        self.op2 = ResNetUnit(amount=9, in_channel=256, out_channel=256)
        self.op3 = DenseNetUnit(k=20, amount=9, in_channel=256, out_channel=244, max_input_channel=64)
        self.op4 = DenseNetUnit(k=12, amount=9, in_channel=244, out_channel=236, max_input_channel=128)
        self.op8 = DenseNetUnit(k=40, amount=3, in_channel=236, out_channel=152, max_input_channel=32)
        self.op9 = DenseNetUnit(k=20, amount=4, in_channel=152, out_channel=144, max_input_channel=64)
        self.op11 = ResNetUnit(amount=7, in_channel=144, out_channel=64)
