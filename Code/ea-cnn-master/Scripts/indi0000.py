...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=6, in_channel=3, out_channel=256)
        self.op1 = ResNetUnit(amount=10, in_channel=256, out_channel=128)
        self.op2 = ResNetUnit(amount=11, in_channel=128, out_channel=128)
        self.op4 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
        self.op6 = DenseNetUnit(k=20, amount=7, in_channel=152, out_channel=204, max_input_channel=64)
        self.op7 = ResNetUnit(amount=4, in_channel=204, out_channel=64)
        self.op8 = DenseNetUnit(k=20, amount=10, in_channel=64, out_channel=264, max_input_channel=64)
        self.op11 = DenseNetUnit(k=20, amount=9, in_channel=264, out_channel=244, max_input_channel=64)
