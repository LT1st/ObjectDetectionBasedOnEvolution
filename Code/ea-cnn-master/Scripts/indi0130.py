...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=12, amount=6, in_channel=64, out_channel=136, max_input_channel=128)
        self.op3 = DenseNetUnit(k=12, amount=10, in_channel=136, out_channel=248, max_input_channel=128)
        self.op4 = DenseNetUnit(k=20, amount=6, in_channel=248, out_channel=184, max_input_channel=64)
        self.op5 = DenseNetUnit(k=40, amount=5, in_channel=184, out_channel=232, max_input_channel=32)
        self.op7 = DenseNetUnit(k=12, amount=6, in_channel=232, out_channel=200, max_input_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=3, in_channel=200, out_channel=164, max_input_channel=128)
        self.op11 = ResNetUnit(amount=10, in_channel=164, out_channel=64)
        self.op12 = ResNetUnit(amount=3, in_channel=64, out_channel=256)
        self.op13 = DenseNetUnit(k=20, amount=5, in_channel=256, out_channel=164, max_input_channel=64)
        self.op14 = ResNetUnit(amount=8, in_channel=164, out_channel=256)
        self.op15 = DenseNetUnit(k=20, amount=8, in_channel=256, out_channel=224, max_input_channel=64)

        #linear unit
        self.linear = nn.Linear(32256, 6)
