...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=20, amount=5, in_channel=3, out_channel=103, max_input_channel=64)
        self.op3 = DenseNetUnit(k=40, amount=3, in_channel=103, out_channel=152, max_input_channel=32)
        self.op4 = ResNetUnit(amount=3, in_channel=152, out_channel=256)
        self.op5 = DenseNetUnit(k=40, amount=3, in_channel=256, out_channel=152, max_input_channel=32)
        self.op8 = DenseNetUnit(k=40, amount=4, in_channel=152, out_channel=192, max_input_channel=32)
