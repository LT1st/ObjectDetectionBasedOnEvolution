...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=5, in_channel=3, out_channel=64)
        self.op1 = DenseNetUnit(k=40, amount=5, in_channel=64, out_channel=232, max_input_channel=32)
        self.op2 = DenseNetUnit(k=40, amount=3, in_channel=232, out_channel=152, max_input_channel=32)
        self.op6 = ResNetUnit(amount=3, in_channel=152, out_channel=256)
        self.op7 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op8 = ResNetUnit(amount=7, in_channel=232, out_channel=256)
        self.op9 = DenseNetUnit(k=40, amount=3, in_channel=256, out_channel=152, max_input_channel=32)
        self.op10 = ResNetUnit(amount=4, in_channel=152, out_channel=64)
        self.op11 = ResNetUnit(amount=7, in_channel=64, out_channel=128)
        self.op12 = ResNetUnit(amount=5, in_channel=128, out_channel=64)
        self.op13 = DenseNetUnit(k=40, amount=5, in_channel=64, out_channel=232, max_input_channel=32)
