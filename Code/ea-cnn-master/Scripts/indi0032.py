...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=7, in_channel=3, out_channel=256)
        self.op2 = DenseNetUnit(k=40, amount=5, in_channel=256, out_channel=232, max_input_channel=32)
        self.op4 = DenseNetUnit(k=12, amount=4, in_channel=232, out_channel=176, max_input_channel=128)
        self.op7 = DenseNetUnit(k=40, amount=4, in_channel=176, out_channel=192, max_input_channel=32)
        self.op8 = DenseNetUnit(k=20, amount=4, in_channel=192, out_channel=144, max_input_channel=64)
        self.op9 = DenseNetUnit(k=40, amount=5, in_channel=144, out_channel=232, max_input_channel=32)
        self.op10 = DenseNetUnit(k=40, amount=4, in_channel=232, out_channel=192, max_input_channel=32)
