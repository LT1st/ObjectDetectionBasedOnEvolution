...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = DenseNetUnit(k=12, amount=3, in_channel=64, out_channel=100, max_input_channel=128)
        self.op4 = ResNetUnit(amount=5, in_channel=100, out_channel=256)
        self.op6 = DenseNetUnit(k=12, amount=9, in_channel=256, out_channel=236, max_input_channel=128)
        self.op9 = DenseNetUnit(k=20, amount=9, in_channel=236, out_channel=244, max_input_channel=64)
