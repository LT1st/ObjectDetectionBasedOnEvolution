...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=20, amount=5, in_channel=128, out_channel=164, max_input_channel=64)
        self.op5 = DenseNetUnit(k=40, amount=3, in_channel=164, out_channel=152, max_input_channel=32)
        self.op6 = ResNetUnit(amount=5, in_channel=152, out_channel=64)
        self.op7 = ResNetUnit(amount=6, in_channel=64, out_channel=64)
        self.op9 = DenseNetUnit(k=12, amount=7, in_channel=64, out_channel=148, max_input_channel=128)
        self.op10 = DenseNetUnit(k=12, amount=7, in_channel=148, out_channel=212, max_input_channel=128)

        #linear unit
        self.linear = nn.Linear(30528, 6)
