...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=8, in_channel=256, out_channel=224, max_input_channel=128)
        self.op4 = ResNetUnit(amount=5, in_channel=224, out_channel=128)
        self.op5 = ResNetUnit(amount=7, in_channel=128, out_channel=128)
        self.op6 = DenseNetUnit(k=12, amount=4, in_channel=128, out_channel=176, max_input_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=4, in_channel=176, out_channel=176, max_input_channel=128)
        self.op9 = DenseNetUnit(k=20, amount=7, in_channel=176, out_channel=204, max_input_channel=64)
