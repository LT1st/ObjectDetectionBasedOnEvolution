...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op3 = ResNetUnit(amount=7, in_channel=152, out_channel=64)
        self.op5 = DenseNetUnit(k=20, amount=3, in_channel=64, out_channel=124, max_input_channel=64)
        self.op6 = ResNetUnit(amount=10, in_channel=124, out_channel=64)
        self.op8 = DenseNetUnit(k=12, amount=5, in_channel=64, out_channel=124, max_input_channel=128)
        self.op9 = ResNetUnit(amount=9, in_channel=124, out_channel=128)
        self.op10 = DenseNetUnit(k=20, amount=10, in_channel=128, out_channel=264, max_input_channel=64)

        #linear unit
        self.linear = nn.Linear(38016, 6)
