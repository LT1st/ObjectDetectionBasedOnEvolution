...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=9, in_channel=3, out_channel=128)
        self.op3 = ResNetUnit(amount=6, in_channel=128, out_channel=64)
        self.op5 = ResNetUnit(amount=7, in_channel=64, out_channel=128)
        self.op6 = DenseNetUnit(k=40, amount=4, in_channel=128, out_channel=192, max_input_channel=32)
        self.op8 = DenseNetUnit(k=20, amount=8, in_channel=192, out_channel=224, max_input_channel=64)
        self.op9 = DenseNetUnit(k=20, amount=7, in_channel=224, out_channel=204, max_input_channel=64)
        self.op10 = ResNetUnit(amount=9, in_channel=204, out_channel=64)
        self.op11 = DenseNetUnit(k=20, amount=5, in_channel=64, out_channel=164, max_input_channel=64)
