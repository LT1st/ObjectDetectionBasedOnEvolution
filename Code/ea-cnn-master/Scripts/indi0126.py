...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=9, in_channel=75, out_channel=64)
        self.op3 = DenseNetUnit(k=20, amount=3, in_channel=64, out_channel=124, max_input_channel=64)
        ...
        self.op8 = DenseNetUnit(k=40, amount=5, in_channel=188, out_channel=232, max_input_channel=32)
