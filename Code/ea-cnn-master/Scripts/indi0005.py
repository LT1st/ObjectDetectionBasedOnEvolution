...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=20, amount=9, in_channel=3, out_channel=183, max_input_channel=64)
        self.op1 = DenseNetUnit(k=20, amount=5, in_channel=183, out_channel=164, max_input_channel=64)
        self.op3 = ResNetUnit(amount=6, in_channel=164, out_channel=64)
        self.op4 = DenseNetUnit(k=40, amount=5, in_channel=64, out_channel=232, max_input_channel=32)
        self.op5 = DenseNetUnit(k=20, amount=9, in_channel=232, out_channel=244, max_input_channel=64)
        self.op6 = DenseNetUnit(k=20, amount=10, in_channel=244, out_channel=264, max_input_channel=64)
        self.op7 = ResNetUnit(amount=7, in_channel=264, out_channel=64)
