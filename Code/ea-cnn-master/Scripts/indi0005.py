...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=9, in_channel=64, out_channel=128)
        self.op2 = ResNetUnit(amount=4, in_channel=128, out_channel=128)
        self.op5 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
        self.op6 = ResNetUnit(amount=6, in_channel=152, out_channel=256)
