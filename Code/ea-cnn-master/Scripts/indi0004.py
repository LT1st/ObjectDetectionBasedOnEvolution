...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = ResNetUnit(amount=7, in_channel=256, out_channel=256)
        self.op4 = ResNetUnit(amount=3, in_channel=256, out_channel=256)
        self.op6 = ResNetUnit(amount=6, in_channel=256, out_channel=128)
        self.op8 = DenseNetUnit(k=12, amount=8, in_channel=128, out_channel=224, max_input_channel=128)
