...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = DenseNetUnit(k=20, amount=7, in_channel=3, out_channel=143, max_input_channel=64)
        self.op2 = DenseNetUnit(k=20, amount=3, in_channel=143, out_channel=124, max_input_channel=64)
        ...
        self.op8 = DenseNetUnit(k=12, amount=8, in_channel=256, out_channel=224, max_input_channel=128)
        self.op9 = ResNetUnit(amount=9, in_channel=224, out_channel=128)
        self.op11 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
        self.op13 = ResNetUnit(amount=9, in_channel=152, out_channel=128)
