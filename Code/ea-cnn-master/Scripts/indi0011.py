...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=9, in_channel=128, out_channel=128)
        self.op6 = ResNetUnit(amount=3, in_channel=128, out_channel=256)
        self.op7 = DenseNetUnit(k=20, amount=10, in_channel=256, out_channel=264, max_input_channel=64)
        self.op8 = DenseNetUnit(k=40, amount=3, in_channel=264, out_channel=152, max_input_channel=32)
