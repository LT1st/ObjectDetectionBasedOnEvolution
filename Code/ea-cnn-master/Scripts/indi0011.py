...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=6, in_channel=256, out_channel=200, max_input_channel=128)
        self.op5 = DenseNetUnit(k=12, amount=7, in_channel=200, out_channel=212, max_input_channel=128)
        self.op6 = DenseNetUnit(k=12, amount=5, in_channel=212, out_channel=188, max_input_channel=128)
        self.op8 = DenseNetUnit(k=20, amount=9, in_channel=188, out_channel=244, max_input_channel=64)
