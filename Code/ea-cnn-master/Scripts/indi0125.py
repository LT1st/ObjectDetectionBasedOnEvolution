...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op2 = DenseNetUnit(k=20, amount=10, in_channel=204, out_channel=264, max_input_channel=64)
        self.op4 = DenseNetUnit(k=12, amount=10, in_channel=264, out_channel=248, max_input_channel=128)
        self.op5 = DenseNetUnit(k=20, amount=6, in_channel=248, out_channel=184, max_input_channel=64)
        self.op6 = DenseNetUnit(k=40, amount=4, in_channel=184, out_channel=192, max_input_channel=32)
        self.op8 = ResNetUnit(amount=6, in_channel=192, out_channel=128)
