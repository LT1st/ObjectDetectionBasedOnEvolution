...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=3, in_channel=128, out_channel=64)
        self.op3 = ResNetUnit(amount=3, in_channel=64, out_channel=64)
        self.op7 = DenseNetUnit(k=40, amount=5, in_channel=64, out_channel=232, max_input_channel=32)
        self.op8 = DenseNetUnit(k=12, amount=7, in_channel=232, out_channel=212, max_input_channel=128)
