...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = DenseNetUnit(k=12, amount=7, in_channel=64, out_channel=148, max_input_channel=128)
        self.op3 = DenseNetUnit(k=20, amount=5, in_channel=148, out_channel=164, max_input_channel=64)
        self.op4 = DenseNetUnit(k=20, amount=9, in_channel=164, out_channel=244, max_input_channel=64)
        self.op5 = DenseNetUnit(k=20, amount=10, in_channel=244, out_channel=264, max_input_channel=64)
        self.op6 = ResNetUnit(amount=9, in_channel=264, out_channel=64)
        self.op10 = ResNetUnit(amount=6, in_channel=64, out_channel=256)
