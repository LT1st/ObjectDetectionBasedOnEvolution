...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op0 = ResNetUnit(amount=12, in_channel=3, out_channel=64)
        self.op1 = DenseNetUnit(k=20, amount=7, in_channel=64, out_channel=204, max_input_channel=64)
        self.op2 = DenseNetUnit(k=12, amount=8, in_channel=204, out_channel=224, max_input_channel=128)
        self.op5 = DenseNetUnit(k=20, amount=4, in_channel=224, out_channel=144, max_input_channel=64)
        self.op7 = ResNetUnit(amount=7, in_channel=144, out_channel=128)
        self.op9 = DenseNetUnit(k=20, amount=7, in_channel=128, out_channel=204, max_input_channel=64)
        self.op10 = ResNetUnit(amount=7, in_channel=204, out_channel=256)
        self.op11 = DenseNetUnit(k=12, amount=6, in_channel=256, out_channel=200, max_input_channel=128)
        self.op12 = ResNetUnit(amount=10, in_channel=200, out_channel=256)

        #linear unit
        self.linear = nn.Linear(36864, 6)
