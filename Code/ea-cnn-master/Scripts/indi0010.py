...
class EvoCNNModel(nn.Module):
    def __init__(self, in_size=200, num_class=6, input_channel=3):
        ...
        self.op1 = ResNetUnit(amount=7, in_channel=256, out_channel=64)
        self.op2 = DenseNetUnit(k=12, amount=9, in_channel=64, out_channel=172, max_input_channel=128)
        self.op3 = ResNetUnit(amount=3, in_channel=172, out_channel=64)
        self.op4 = DenseNetUnit(k=20, amount=10, in_channel=64, out_channel=264, max_input_channel=64)
        self.op6 = DenseNetUnit(k=40, amount=5, in_channel=264, out_channel=232, max_input_channel=32)
        self.op9 = DenseNetUnit(k=20, amount=10, in_channel=232, out_channel=264, max_input_channel=64)
        self.op11 = ResNetUnit(amount=4, in_channel=264, out_channel=256)
